    ...
    <div class="col-md-12 col-xs-12" id="InformacionCuadro" >
        <div class="panel panel-default">
            ...
            <div class="panel-body col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1" >
                <div id="myChart" class="col-md-12 col-xs-12"></div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var dateBeging = "<?php echo $Date1;?>";
    var dateEnd = "<?php echo $Date2;?>";
    var chartDiv = "myChart";
    var idParametro = <?php echo $primerParametro;?>;
    ...
    GenerarGrafica (id_equipo_rec, idParametro, dateBeging, dateEnd);
